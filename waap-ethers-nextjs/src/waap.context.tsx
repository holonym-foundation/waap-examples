...
import { CredentialType, initSilk as initWaaP, SILK_METHOD as WAAP_METHOD, SilkEthereumProviderInterface as WaaPEthereumProviderInterface } from '@silk-wallet/silk-wallet-sdk'
